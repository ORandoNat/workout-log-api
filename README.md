...
- April 10, 2026 - Add labels to addWorkout and editWorkout forms. Refactored event wiring. Removed inline styling from HTML and created a 'hidden' class to toggle visibility on the edit form, notes, and error messages.
